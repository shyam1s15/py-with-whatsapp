...
my_file = os.path.join(THIS_FOLDER, 'main.py')
...
# C:\Users\shyam\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Python 3.9
...
if platform.system()=="Windows":
    driver = webdriver.Chrome(executable_path="/".join([THIS_FOLDER,"chromedriver.exe"]))
else:
    driver = webdriver.Chrome(r"/".join([THIS_FOLDER,"chromedriver"]) )

# driver = webdriver.Chrome(r'/Users/macbookpro/Documents/chromedriver')
...
def main():
    ...
    for moblie_no in moblie_no_list:
        try:
            ...
            # send_whatsapp_msg(phone_no=moblie_no, text=my_file)
    ...
    a = input('process completed, will be killed soon hit enter')
